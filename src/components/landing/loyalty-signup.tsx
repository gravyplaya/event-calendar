      ...
      <div className="glass-strong h-full rounded-3xl p-8 md:p-12">
        <div className="mb-8 text-center">
          ...
          <p className="text-muted-foreground text-lg">
            Earn points for every visit. Get food and drink discounts. It&apos;s
            free to join — and you&apos;ll get{' '}
            <span className="text-primary font-semibold">100 bonus points</span>{' '}
            just for signing up.
          </p>
        </div>
